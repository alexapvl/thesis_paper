...
End-to-end audio-to-light updates must remain within a perceptually synchronous latency budget during interactive playback. This target is justified both by the \fullref{chap:theoretical-background}{Chapter} discussion of sound-to-light latency and by the practical requirement specification that set a sub-100 ms end-to-end target for the application.
